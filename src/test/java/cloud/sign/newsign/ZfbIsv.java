...
public class ZfbIsv extends AbstractTestNGSpringContextTests {
    ...
    public void zfbisv(){
        String requstjson ="{\"serviceId\":\"fc.park.signatoryResult.OrderQuery\",\"data\":{\"parkCode\":\"20181213001\",\"dataItems\":[{\"carNo\":\""+Constants.ZFBISV+"\",\"inTime\":\""+Constants.SATA +"\",\"vehicleInfo\":\"{\\\"plateColor\\\":\\\"BLUE\\\"}\"}]}}";
        //获取验签反查密钥
